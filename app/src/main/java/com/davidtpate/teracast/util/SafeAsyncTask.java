 ...
 * <p/>
 * If you're familiar with AsyncTask and are looking for {@link android.os.AsyncTask#doInBackground(Object[])}, we've
 * named it {@link #call()} here to conform with java 1.5's {@link java.util.concurrent.Callable} interface.
 * <p/>
...
public abstract class SafeAsyncTask<ResultT> implements Callable<ResultT> {
	...
	public static class Task<ResultT> implements Callable<Void> {
        ...
        /**
         * Posts the specified runnable to the UI thread using a handler, and waits for operation to finish.  If there's
